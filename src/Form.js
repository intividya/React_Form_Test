    ...
    return (
      <form className="demoForm" onSubmit={this.handleSubmit}>
        ...
        <div className={`form-group ${this.errorClass(this.state.formErrors.socialSecurityNumber)}`}>
          ...
          <input type="socialSecurityNumber" required className="form-control" name="socialSecurityNumber" placeholder="Social Security Number" value={this.state.socialSecurityNumber} onChange={this.handleUserInput}  />
        ...
        <div className={`form-group ${this.errorClass(this.state.formErrors.phoneNumber)}`}>
          ...
          <input type="phoneNumber" required className="form-control" name="phoneNumber" placeholder="Phone Number" value={this.state.phoneNumber} onChange={this.handleUserInput} />
